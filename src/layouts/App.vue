    ...
    <div id="app">
        ...
        <mu-dialog title="手机号登录" width="600" max-width="80%" :esc-press-close="false" :overlay-close="false"
            ...
            <section class="login">
                ...
                <label for="">
                    <span></span>
                    <input type="number" placeholder="" v-model="imgCode">
                    <img :src="img_code_url" alt="" style="width: 94px;height: 30px" @click="reGetImgCode">
                </label>
                <label for="">
                    <span> </span>
        ...
        <mu-dialog title="您还未登录，请登录后解锁更多功能" width="600" max-width="80%" :esc-press-close="false" :overlay-close="false" :open.sync="openAlertWx">
...
<script>
    ...
    const codeImgUrl = 'http://zhuge.uzhuang.com/index.php?r=login/show-picture&rd='
    ...
    export default {
        ...
        data() {
            return {
                ...
                tel: '',
                imgCode: null,
                img_code_url: codeImgUrl + Math.random(),
                send_text: '获取验证码',
                time: sendTime,
                codepic: null,
                targerPage: '',
        ...
        methods: {
            ...
            reGetImgCode() {
                this.img_code_url = codeImgUrl + Math.random()
            },
            // goLogin
            goLogin() {
                if (this.tel == '') {
